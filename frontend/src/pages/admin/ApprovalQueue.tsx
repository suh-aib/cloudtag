import { Cloud, ArrowRight, ChevronDown, ChevronRight, Activity } from "lucide-react";
...
import { getApprovalQueue } from "../../services/api/approvals";
    ...
    <div className="space-y-6 max-w-7xl mx-auto py-2">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Review pending bulk tagging proposals across the organization.</p>
        </div>
      </div>
