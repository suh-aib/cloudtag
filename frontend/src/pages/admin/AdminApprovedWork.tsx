import { Cloud, ArrowRight, ChevronDown, ChevronRight, CheckCircle } from "lucide-react";
...
import { getApprovedWork } from "../../services/api/approvals";
...
export default function AdminApprovedWork() {
    ...
    <div className="space-y-6 max-w-7xl mx-auto py-2">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Review all approved tagging submissions across the organization.</p>
        </div>
      </div>
                                    ...
                                    <div key={batch.id} className="flex items-center justify-between p-3 hover:bg-gray-50">
                                      ...
                                      <div className="flex items-center gap-4">
                                        ...
                                        <button 
                                          onClick={(e) => {
                                            e.stopPropagation();
                                            // Re-using ApprovalWorkspace which is technically a "Review" workspace, but works perfectly well for viewing approved hierarchies too!
                                            navigate(`/admin/approvals/${batch.batch_id}`);
                                          }}
